# DOWNLOAD SPRINGER NATURE COVID-19 FREEBOOKS 
#
...
#
# VERSION 1.0 
# COPYRIGTH PROF MARCELO S ZANETTI 
# LICENSE GPL V3

# HOW TO RUN
# python downloadFreebooksSN
#-------to download the english books hardcoded in the list variable DB (SEE VARIABLES)
# python downloadFreebooksSN list.txt
#-------to provide a text file containing a springer book url per line (SEE MAIN and SOURCE)
...
'http://link.springer.com/openurl?genre=book&isbn=978-3-319-32185-1',
...
'http://link.springer.com/openurl?genre=book&isbn=978-3-030-19128-3',
...
def download_book(url):
	try:	
		...
		if link==None or len(link)==0 or link.find("pdf")<0 :
			raise
		if link.find("http")<0:		
			link = BASEURL+link
